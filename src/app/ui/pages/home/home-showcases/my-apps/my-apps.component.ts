...
export class MyAppsComponent implements OnInit {
  ...
  _mApps : AppType[] = [
    ...
    {
     "name": "Personal Porfolio Website",
     "image": "assets/img/apps/website.png",
     "link": "https://hubert-wong.github.io",
     "caption": "In Angular -",
     "isFull": false,
     "primary":"#3FD67D",
     "background":"#E1E1E1"
   ...
   {
     "name": "Personal Video Game Database",
     "image": "assets/img/apps/videogamedb.png",
     "link": "https://github.com/hubert-wong/projects",
     "isFull": false,
     "caption": "In C++, using ML -",
     "background":"#F5E7B4"
   },
  ];
